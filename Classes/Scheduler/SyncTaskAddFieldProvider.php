...
class Tx_Dflsync_Scheduler_SyncTaskAddFieldProvider implements tx_scheduler_AdditionalFieldProvider {
	...
	public function getAdditionalFields(array &$taskInfo, $task, tx_scheduler_Module $parentObject) {
		...
		$this->makeField($additionalFields, FIELD_COMPETITION, $taskInfo);
	...
	private function makeField(&$additionalFields, $fieldName, $taskInfo) {
		...
		'" value="' . $taskInfo[$fieldName] . '" size="30" />';
